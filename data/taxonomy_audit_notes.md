...
## Replacement-photo download validation (2026-09-17 UTC)

[Download/decoder and within-batch byte-hash report](replacement_download_validation_11.json) ([workflow](https://github.com/Dergah29/BitkiDok-Android/actions/runs/35286488890)) retained **105 decodable medium photos from 105 distinct iNaturalist observations** across five replacement taxa: Dischidia nummularia 57, Monstera pinnatipartita 40, Alocasia micholitziana 3, Pilea mollis 2, Hoya lacunosa 3. Fifteen attempted images were rejected as too small or unsupported. The checker stops after one usable image per observation and caps each species at 90, so counts must not be interpreted as a full audit of all 220 photo metadata entries. Only the first two taxa exceed the provisional 12-image threshold. The audit did not cross-check GBIF hashes, perceptual duplicates, actual botanical identity, individual plant overlap, image composition, or independent phone-photo generalization. None are promoted to training data.

## Additional fern/prayer-plant expansion (2026-09-18 UTC)

[25-name GBIF taxonomy audit](expansion_taxa_candidates_25.json) found **24 distinct accepted species-rank taxa** not in the original catalog or first 11 replacements. Pilea involucrata was excluded because GBIF's strict match resolved to the Pilea **genus**, not an accepted species. In a limited [photo-specific CC0/CC BY metadata check](expansion_photo_coverage_24.json), 1,582 photo entries appeared across 24 queried species, with eight species provisionally exceeding 12 distinct observations. The [bounded image download/decoder audit](expansion_download_validation_24.json) retained **172 distinct-observation medium images across 15 species**. Eight have at least 12 decoded photos: Maranta leuconeura 14; Goeppertia zebrina 20; Nephrolepis exaltata 20; Asplenium nidus 20; Platycerium bifurcatum 20; Davallia fejeensis 20; Phlebodium aureum 20; Alocasia odora 20. Forty-eight attempted images failed the minimum-size/format check. Downloads were capped at 20 usable observations per species; counts above that are not implied.

These eight plus the prior two photo-rich candidates are **metadata-and-decoder leads only**. License claims require final photo-level audit; IDs, photographers, original plants, perceptual near-duplicates, botanical correctness, and the potted indoor domain have not been confirmed. The existing model is still 101 classes, not 200, and no phone-photo accuracy is established. Do not silently swap seven catalog entries or train these candidates until checks and independent evaluation are complete.
